...
# 用法:
#   bash quick_starts/run_viz_docker.sh [mode] [episode]
#
# 示例:
#   bash quick_starts/run_viz_docker.sh stats 0        # 纯统计模式（默认）
#   bash quick_starts/run_viz_docker.sh web   0        # Web Viewer（浏览器访问）
#   bash quick_starts/run_viz_docker.sh save  0        # 保存 .rrd 文件
#
